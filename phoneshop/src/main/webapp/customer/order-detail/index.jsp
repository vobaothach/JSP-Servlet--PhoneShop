...
<head>
    ...
    <link rel="stylesheet" href="/customer/order-detail/style.css"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8 col-sm-12 col-xs-12">
                                                                        <div class="bg-scroll-webblog">
                                                                            ...
                                                                            <div class="cart-droplist__status visible-xs">
                                                                                <i class="fa fa-check"
                                                                                   aria-hidden="true"></i> <span
                                                                                    class="cart-counter-list"><span
                                                                                    class="simpleCart_quantity">0</span></span>
                                                                                    ...
                                                                                    <c:forEach
                                                                                        ...
                                                                                        <div class="cart-item">
                                                                                            <div class="cart-item-container">
                                                                                                <div class="cart-item thumb" id="${orderItem.id}">
                                                                                                    <img src="${orderItem.product.imgSource}">
                                                                                                </div>
                                                                                                <div class="cart-item name">
                                                                                                    <span class="item-name" id="product-id-${orderItem.product.id}">${orderItem.product.name}</span>
                                                                                                </div>
                                                                                                <div class="cart-item price"
                                                                                                     id="price-${orderItem.product.id}"><fmt:formatNumber value="${orderItem.product.price}" minFractionDigits="0" maxFractionDigits="0"/>
                                                                                                    VND
                                                                                                </div>
...
<%--                                                                                                        </div>--%>
                                                                                                ...
                                                                                                <div class="cart-item total"
                                                                                                    ...
                                                                                                    <fmt:formatNumber value="${orderItem.subtotal}" minFractionDigits="0" maxFractionDigits="0"/>
                                                                                                    VND
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
...
<script src="/customer/order-detail/main.js"></script>
