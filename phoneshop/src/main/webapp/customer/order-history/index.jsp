...
<head>
    ...
    <link rel="stylesheet" href="/customer/order-history/style.css" />
...
<body id="a-mobile-store" ontouchstart="" data-new-gr-c-s-check-loaded="14.1043.0" data-gr-ext-installed="">
                ...
                <table class="my-table">
                    ...
                    <c:forEach items="${orders}" var="order">
                        <tr>
                            ...
                            <td>${order.date}</td>
                            <td>${order.address}</td>
                            <td><fmt:formatNumber value="${order.total}" minFractionDigits="0" maxFractionDigits="0"/></td>
                            <td>
                                <button class="detail-btn" onclick="location.href = '/order-detail?id=' + ${order.id}">Detail</button>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
    ...
    <script src="/customer/order-history/main.js"></script>
