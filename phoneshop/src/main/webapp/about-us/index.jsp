...
<body id="a-mobile-store" ontouchstart="" data-new-gr-c-s-check-loaded="14.1043.0" data-gr-ext-installed="">
            ...
            <div class="members">
                <div class="member-card">
                    <div class="member-avatar">
                        <img src="https://ahead.lk/wp-content/uploads/2020/11/pngtree-user-vector-avatar-png-image_1541962.jpg">
                    </div>
                    <div class="member-detail">
                        <h4>Name: Nguyen Van A</h4>
                        <h5>Class: ...</h5>
                        <h5>Github: ...</h5>
                    </div>
                </div>
    ...
    <script src="/about-us/main.js"></script>
